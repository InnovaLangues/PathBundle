...
class StepManager
{
    ...
    public function create(Path $path, $level = 0, Step $parent = null, $order = 0, \stdClass $stepStructure)
    {
        ...
        return $this->edit($path, $level, $parent, $order, $stepStructure, $step, true);
    }
     ...
     * @return \Innova\PathBundle\Entity\Step      Edited step
     */
    public function edit(Path $path, $level = 0, Step $parent = null, $order = 0, \stdClass $stepStructure, Step $step, $flush = true)
    {
